...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const location = allAustralianCities.find(loc => loc.slug === slug);
    ...
    return {
        title: `${location.name} SEO Services | Rank Higher`,
        description: `Dominate ${location.name} search results. Local SEO experts helping ${location.name} businesses get more customers. Free audit available →`,
    };
}
