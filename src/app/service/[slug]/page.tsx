...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        title: `${service.title} | Expert SEO Services`,
        description: `${service.description.slice(0, 120)}... Get results with our proven ${service.title.toLowerCase()} strategies.`,
    };
}
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <AnimatedSection className="mb-4" animation="fade-in">
                        <div className="inline-flex items-center space-x-2">
                            <Link href="/" className="text-seo-gray-dark hover:text-seo-blue transition-colors">Home</Link>
                            <ChevronRight className="h-4 w-4 text-seo-gray-medium" />
                            <Link href="/services" className="text-seo-gray-dark hover:text-seo-blue transition-colors">Services</Link>
                            <ChevronRight className="h-4 w-4 text-seo-gray-medium" />
